...
const apiKeys: NamespaceModule = {
  en: {
    ...
    colRevoked: 'Revoked',
    colExpires: 'Expires',
    colExempt: 'Suppression-exempt',
    exempt: 'Exempt from suppression',
    unexempt: 'Enforce suppression',
    fieldName: 'Name',
  ...
  ru: {
    ...
    colRevoked: 'Отозван',
    colExpires: 'Истекает',
    colExempt: 'Без подавления',
    exempt: 'Исключить из подавления',
    unexempt: 'Применять подавление',
    fieldName: 'Имя',
